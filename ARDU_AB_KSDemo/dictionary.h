...
PROGMEM const unsigned char library[] =
{
  ...
  // PLACE 236 : THANKS
  6,
  CHAR_T, CHAR_H, CHAR_A, CHAR_N, CHAR_K, CHAR_S,
  // PLACE 237 : BACKING
  7,
  CHAR_B, CHAR_A, CHAR_C, CHAR_K, CHAR_I, CHAR_N, CHAR_G,
  // PLACE 238 : KICKSTARTER
  11,
  CHAR_K, CHAR_I, CHAR_C, CHAR_K, CHAR_S, CHAR_T, CHAR_A, CHAR_R, CHAR_T, CHAR_E, CHAR_R,
  // PLACE 239 : CAMPAIGN
  8,
  CHAR_C, CHAR_A, CHAR_M, CHAR_P, CHAR_A, CHAR_I, CHAR_G, CHAR_N,
  // PLACE 240 : TOO
  3,
  CHAR_T, CHAR_O, CHAR_O,
};
...
PROGMEM const unsigned char sentences[] =
{
  ...
  14,
  135, SPACE, 136, SPACE, 137, SPACE, 138, 41, 60, NEWLINE, 240, SPACE, 139, 39,
  ...
  // PLACE 78 : THANKS FOR BACKING OUR KICKSTARTER!
  10,
  236, SPACE, 147, SPACE, 237, NEWLINE, 129, SPACE, 238, 39,
