...
PROGMEM const unsigned char sentences[] =
{
  ...
  8,
  DOUBLESPACE, 197, DOUBLENEWLINE, 198, DOUBLENEWLINE, SPACE, SPACE, 208,
  ...
  13,
  SPACE, 12, TRIPLESPACE, 237, FOURSPACE, FOURSPACE, NEWLINE, SPACE, 127, TRIPLESPACE, 69, SPACE, 71,
  ...
  22,
  62, SPACE, 190, SPACE, 191, SPACE, 58, SPACE, 144, 39, NEWLINE, 192, SPACE, 193, SPACE, 199, SPACE, 74, SPACE, 58, SPACE, 183,

  // PLACE 64 : HP:___/___MP:___/___
  10,
  83, 42, TRIPLESPACE, 43, FOURSPACE, 84, 42, TRIPLESPACE, 43, TRIPLESPACE,
  ...
  6,
  FOURSPACE, NEWLINE, 234, SPACE, 40, DOUBLESPACE,
