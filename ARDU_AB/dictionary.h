...
PROGMEM const unsigned char sentences[] =
{
  ...
  23,
  210, SPACE, 7, SPACE, 197, NEWLINE, 61, SPACE, 75, SPACE, 211, 37, SPACE, 212, NEWLINE, 213, SPACE, 75, SPACE, 101, NEWLINE, 214, 37,

  // PLACE 66 : SELECT YOUR GAME AND UPLOAD. WHEN DONE RELEASE THE DOWN KEY
  28,
  215, SPACE, 7, SPACE, 3, SPACE, 216, NEWLINE, 209, 37, SPACE, 217, SPACE, 209, NEWLINE, 76, SPACE, 218, 38, SPACE, 219, NEWLINE, 75, SPACE, 101, SPACE, 214, 47,
