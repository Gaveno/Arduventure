...
PROGMEM const unsigned char sentences[] =
{
  ...
  14,
  SPACE, 12, TRIPLESPACE, 69 , SPACE, 180, DOUBLESPACE, NEWLINE, SPACE, 127, TRIPLESPACE, 69, SPACE, 71,
  ...
  15,
  151, 152, SPACE, 69, SPACE, 180, 39, NEWLINE, 191, DOUBLESPACE, 84, SPACE, 147, FOURSPACE, SPACE,
